        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-2xl">
          ...
          <div className="space-y-2">
            <button
              type="button"
              disabled
              className="w-full flex items-center justify-center gap-2.5 border border-zinc-700 rounded-lg py-2.5 text-sm text-zinc-500 cursor-not-allowed opacity-50"
            >
